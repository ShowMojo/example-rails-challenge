class ChargesController < ApplicationController
  ...
  # GET /charges.json
  def index
    @failed_charges = Charge.where("paid=? OR refunded=?", false, true)
    @disputed_charges = Charge.with_paid(true).with_refunded(true)
    @successful_charges = Charge.with_paid(true).with_refunded(false)
  end
