...
class CreditsControllerTest < ActionController::TestCase
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post :create, credit: { amount: @credit.amount, currency: @credit.currency, customer_id: @credit.customer_id, paid: @credit.paid, refunded: @credit.refunded }
    end
  ...
  test "should update credit" do
    patch :update, id: @credit, credit: { amount: @credit.amount, currency: @credit.currency, customer_id: @credit.customer_id, paid: @credit.paid, refunded: @credit.refunded }
    assert_redirected_to credit_path(assigns(:credit))
  end
