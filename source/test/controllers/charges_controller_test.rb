...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { amount: @charge.amount, created: @charge.created, currency: @charge.currency, paid: @charge.paid, refunded: @charge.refunded } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount: @charge.amount, created: @charge.created, currency: @charge.currency, paid: @charge.paid, refunded: @charge.refunded } }
