...
class CreditCardChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card_charge" do
    assert_difference('CreditCardCharge.count') do
      post credit_card_charges_url, params: { credit_card_charge: { amount: @credit_card_charge.amount, currency: @credit_card_charge.currency, customer_id: @credit_card_charge.customer_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded } }
    end
  ...
  test "should update credit_card_charge" do
    patch credit_card_charge_url(@credit_card_charge), params: { credit_card_charge: { amount: @credit_card_charge.amount, currency: @credit_card_charge.currency, customer_id: @credit_card_charge.customer_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded } }
