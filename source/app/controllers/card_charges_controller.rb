class CardChargesController < ApplicationController
  ...
  def index
    @failed_charges = CardCharge.failed
    @disputed_charges = CardCharge.disputed
    @succesful_charges = CardCharge.succesful
  end
  ...
  private
    ...
    def card_charge_params
      params.require(:card_charge).permit(:paid, :amount, :currency, :refunded, :customer_id, :disputed_at)
    end
end
