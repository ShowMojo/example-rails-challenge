...
class CreditCardChargesControllerTest < ActionController::TestCase
  ...
  test "should create credit_card_charge" do
    assert_difference('CreditCardCharge.count') do
      post :create, credit_card_charge: { amount: @credit_card_charge.amount, created: @credit_card_charge.created, currency: @credit_card_charge.currency, customer_id: @credit_card_charge.customer_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded }
    end
  ...
  test "should update credit_card_charge" do
    patch :update, id: @credit_card_charge, credit_card_charge: { amount: @credit_card_charge.amount, created: @credit_card_charge.created, currency: @credit_card_charge.currency, customer_id: @credit_card_charge.customer_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded }
    assert_redirected_to credit_card_charge_path(assigns(:credit_card_charge))
  end
