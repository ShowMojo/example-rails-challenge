...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { currency: @charge.currency, customer_id: @charge.customer_id, paid: @charge.paid, price: @charge.price, refunded: @charge.refunded }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { currency: @charge.currency, customer_id: @charge.customer_id, paid: @charge.paid, price: @charge.price, refunded: @charge.refunded }
    assert_redirected_to charge_path(assigns(:charge))
  end
