class ChargesController < ApplicationController
  ...
  def index
    ...
    charges.each do |charge|
      if charge.paid == false
        @charges_failed << charge
      elsif charge.paid == true && charge.refunded == true
        @charges_disputed << charge
      else
        @charges_success << charge
      end
    end
  end
  ...
  private
    ...
    def charge_params
      params.require(:charge).permit(:created, :paid, :amount, :currency, :refunded)
    end
end
